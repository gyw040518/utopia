...
from upasset.asset_api import *
from utopia.api import *
from utopia.models import Setting
from upasset.forms import AssetForm, IdcForm
from upasset.models import Asset, IDC, AssetGroup, ASSET_TYPE, ASSET_STATUS
...
def group_add(request):
    ...
    return my_render('upasset/group_add.html', locals(), request)
...
def group_list(request):
    ...
    return my_render('upasset/group_list.html', locals(), request)
...
def asset_add_batch(request):
    ...
    return my_render('upasset/asset_add_batch.html', locals(), request)
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            if af_post.is_valid():
                ...
                emg = u'主机 %s 修改失败' % ip
                return my_render('upasset/error.html', locals(), request)
            return HttpResponseRedirect(reverse('asset_detail')+'?id=%s' % asset_id)

    return my_render('upasset/asset_edit.html', locals(), request)
...
def asset_edit_batch(request):
    ...
    if request.method == 'POST':
        ...
        return my_render('upasset/asset_update_status.html', locals(), request)

    return my_render('upasset/asset_edit_batch.html', locals(), request)
    ...
    if request.method == 'POST':
        ...
        if idc_form.is_valid():
            ...
            if IDC.objects.filter(name=idc_name):
                ...
                return my_render('upasset/idc_add.html', locals(), request)
            else:
                idc_form.save()
...
def idc_list(request):
    ...
    return my_render('upasset/idc_list.html', locals(), request)
