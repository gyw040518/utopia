...
from utopia.api import ServerError, User, Asset, PermRole, AssetGroup, get_object, mkdir, get_asset_info
from utopia.api import logger, Log, TtyLog, get_role_key, CRYPTOR, bash, get_tmp_dir
from upperm.perm_api import gen_resource, get_group_asset_perm, get_group_user_perm, user_have_perm, PermRole
from utopia.settings import LOG_DIR
from upperm.ansible_api import MyRunner
from uplog.models import ExecLog, FileLog
...
class Nav(object):
    ...
    def print_nav():
        ...
        打印提示导航
        """
        msg = """\n\033[1;32m###    欢迎使用UTOPIA统一管理平台   ### \033[0m
