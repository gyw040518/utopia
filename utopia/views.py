...
# from upperm.models import Apply
import paramiko
from utopia.api import *
from utopia.models import Setting
from django.contrib.auth import authenticate, login, logout
from django.contrib.auth.decorators import login_required
from uplog.models import Log, FileLog
from upperm.perm_api import get_group_user_perm, gen_resource
from upasset.models import Asset, IDC
...
def is_latest():
    ...
    lastest_version = urllib.urlopen('http://www.utopia.org/lastest_version.html?jsn=%s' % jsn).read().strip()
    ...
    if request.method == "POST":
        ...
        if setting_raw == 'default':
            ...
            if '' in [username, port]:
                ...
                private_key_dir = os.path.join(BASE_DIR, 'upuser/keys', 'default')
...
def web_terminal(request):
    ...
    return render_to_response('uplog/web_terminal.html', locals())
