...
from upperm.perm_api import *

from upuser.models import User, UserGroup
from upasset.models import Asset, AssetGroup
from upperm.models import PermRole, PermRule, PermSudo, PermPush
from utopia.models import Setting

from upperm.utils import gen_keys
from upperm.ansible_api import MyTask
from upperm.perm_api import get_role_info, get_role_push_host
from utopia.api import my_render, get_object, CRYPTOR

# 设置PERM APP Log
from utopia.settings import LOG_LEVEL
logger = set_log(LOG_LEVEL, filename='utopia_perm.log')
...
def perm_rule_list(request):
    ...
    return my_render('upperm/perm_rule_list.html', locals(), request)
...
def perm_rule_detail(request):
    ...
    return my_render('upperm/perm_rule_detail.html', locals(), request)
...
def perm_rule_add(request):
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            error = e
    return my_render('upperm/perm_rule_add.html', locals(), request)
...
def perm_rule_edit(request):
    ...
    return my_render('upperm/perm_rule_edit.html', locals(), request)
...
def perm_role_list(request):
    ...
    return my_render('upperm/perm_role_list.html', locals(), request)
...
def perm_role_add(request):
    ...
    if request.method == "POST":
        ...
        try:
            ...
            error = e
    return my_render('upperm/perm_role_add.html', locals(), request)
...
def perm_role_detail(request):
    ...
    return my_render('upperm/perm_role_detail.html', locals(), request)
...
def perm_role_edit(request):
    ...
    sudo_all = PermSudo.objects.all()
    if request.method == "GET":
        return my_render('upperm/perm_role_edit.html', locals(), request)
...
def perm_role_push(request):
    ...
    return my_render('upperm/perm_role_push.html', locals(), request)
...
def perm_sudo_list(request):
    ...
    return my_render('upperm/perm_sudo_list.html', locals(), request)
...
def perm_sudo_add(request):
    ...
    return my_render('upperm/perm_sudo_add.html', locals(), request)
...
def perm_sudo_edit(request):
    ...
    return my_render('upperm/perm_sudo_edit.html', locals(), request)
